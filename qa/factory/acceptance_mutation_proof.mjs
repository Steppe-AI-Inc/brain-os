...
const MUTANTS = [
  ...
  { id: 'N23', suite: NT, what: 'the worker re-asserts only its role, not its whole registration (an overwritten record stays overwritten)', edits: [[NODE, "capabilities = coalesce($3::jsonb, n.capabilities), agent_version = coalesce($4, n.agent_version) from was", "capabilities = n.capabilities, agent_version = n.agent_version from was"]] },
