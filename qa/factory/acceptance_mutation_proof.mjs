...
const MUTANTS = [
  ...
  { id: 'N29', suite: NT, what: 'a claim whose reply was lost leaves its run in progress, unworked, for a whole lease', edits: [[NODE, '      if (claimTries++ > 0) await giveBackOrphans(id, mine, log);', '      claimTries++;']] },
