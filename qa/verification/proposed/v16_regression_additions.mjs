...
for (const lit of ['const NEGATED_MENTION =', 'const clauses = normalizedCommand.split(',
...
console.log(`\nv16_regression_additions: ${pass} pass, ${fail} fail (${defectsOpen} open #76 defects reproduce; ${fail - defectsOpen} CONTRACT failures = guards that do not hold as claimed)`);
