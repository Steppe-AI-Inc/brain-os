...
console.log(`\nv15_regression_additions: ${pass} pass, ${fail} fail (${defectsOpen} open #75 defects reproduce; ${fail - defectsOpen} CONTRACT failures = guards that do not hold as claimed)`);
