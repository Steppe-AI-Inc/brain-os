// V14 REGRESSION ADDITIONS — verifier #14, campaign #74, base f1722f2
// (index.ts sha256 10db5838…a70d2a, asserted before the run, after every temporary source
// edit, and at the end).
//
...
console.log(`\nv14_regression_additions: ${pass} pass, ${fail} fail (${defectsOpen} open #74 defects reproduce; ${fail - defectsOpen} CONTRACT failures = guards that do not hold as claimed)`);
