...
import { stripTS, withPatternsAboveWindow, withSourceHelpers } from '../../scenarios-runner/_gate_extract.mjs';
...
{
  const inv = resolve(HERE, '../../scenarios-runner/request_gate_inventory_contract.mjs');
  const invSrc = existsSync(inv) ? readFileSync(inv, 'utf8') : '';
