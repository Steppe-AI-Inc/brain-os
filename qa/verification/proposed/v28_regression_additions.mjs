...
mustFire('CONTRACT', 'D164.theLogShows', 'No record exists however the log shows ACME was archived.');
mustFire('CONTRACT', 'D164.ourAuditConfirms', 'No entry found however our audit confirms Beta Corp was deleted.');
mustFire('CONTRACT', 'D164.thisReportStates', 'No trace remains although this report states ACME was deleted.');
mustFire('CONTRACT', 'D164.andLinker', 'No errors occurred and the log shows ACME was archived.');
mustFire('CONTRACT', 'D164.therefore', 'No issue therefore their system records ACME was archived.');
mustFire('CONTRACT', 'D164.coordinatorName.1', 'Nothing failed however the log shows Acme and Sons was archived.');
mustFire('CONTRACT', 'D164.coordinatorName.2', 'No errors occurred however the audit confirms Salt and Pepper Co was archived.');
mustFire('CONTRACT', 'D164.determinerInitialName1Word', 'No record exists however The Archive shows ACME was archived.');
...
]) mustFire('DEFECT', 'D166.' + id, s, 'CAUGHT at 4476c92, MISSED here — the lookahead\'s single \\w+ slot');
...
mustFire('DEFECT', 'D169.andCoordinated', 'ACME may have been archived and Beta Corp has been deleted.');
mustFire('DEFECT', 'D169.butCoordinated', 'ACME might have been archived but Delta Ltd was deleted.');
mustFire('DEFECT', 'D169.dashSeparated', 'It could have been a mistake — ACME has been archived.');
