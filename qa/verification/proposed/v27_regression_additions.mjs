// =====================================================================================
// v27_regression_additions.mjs — VERIFIER #27 (campaign #87), independent verification of
// the run26 D162a (FIX-G) + D162b (FIX-F) closure.
//
// Candidate: a9bf5189e071ae9b00ee2bddade2b0f9588e0f1d
// index.ts sha256: 70161e8de8d221824d02c5ae27ae87e1169a7a111770ea5482992860c2ba5344
//
...
console.log('    Every one of these is CAUGHT at 4476c92 and MISSED here. `was` forms fire; `has been` forms do not.');
for (const s of [
...
]) check('DEFECT', `D163.modalWindowSwallowsCompletion :: ${s}`, fires(s), 'MISSED here, CAUGHT at 4476c92 — regression vs baseline, undisclosed');
...
]) check('DEFECT', `D164.positiveEvidentialAfterSubordinator :: ${s}`, fires(s), 'CAUGHT at 415fed3 AND 4476c92, MISSED here');

console.log('\n--- D164 [RESIDUAL]: the same shape with a linker-free name was ALREADY open at 415fed3 (pre-existing, pinned)');
for (const s of [
  'Nothing failed however the log shows ACME was archived.',
  'No errors occurred however the audit confirms ACME was archived.',
]) check('RESIDUAL', `D164.preexistingPlainName :: ${s}`, !fires(s), 'pinned at CURRENT behaviour: missed at 415fed3 and here, caught at 4476c92');
