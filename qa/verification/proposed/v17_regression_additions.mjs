...
console.log(`\nv17_regression_additions: ${pass} pass, ${fail} fail (${defectsOpen} open #77 defects reproduce; ${fail - defectsOpen} CONTRACT failures = guards that do not hold as claimed)`);
