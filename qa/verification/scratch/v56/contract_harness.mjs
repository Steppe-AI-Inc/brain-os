...
function extractStructuredBlock(source) {
  ...
  for (const must of ['const requestedIntent', 'No change was made — ', 'const legacyProseFallback', 'const unaccountedCompletionProse', 'result.turnVerdict = {', 'const MUTATION_INTENT_ALWAYS', 'const CONFIRMATION_COMMAND', 'const readsAsCompletion']) {
