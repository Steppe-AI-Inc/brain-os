// VERIFIER #52 — run every qa/scenarios-runner/*.mjs suite and every standing verifier gate as its OWN child
// process; record the CHILD exit status; print each suite's own pass/fail tally; screen for vacuity.
...
writeFileSync('qa/verification/scratch/v52/battery.json', JSON.stringify(results, null, 2));
