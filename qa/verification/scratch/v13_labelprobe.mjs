...
const A = ['Restored Three Companies', 'Closed Five Deals', 'Restored Full Access', 'Completed Final Migration',
  'Restored Backup Yesterday', 'Completed Migration', 'Closed Deals Today', 'Restored Bob Smith', 'Completed Bob Smith Onboarding'];
...
const r1 = P.labels([{ label: 'Closed Loop Systems', id: P.ACME, entityType: 'company' },
...
const r2 = P.labels([{ label: 'the company', id: P.ACME, entityType: 'company' },
...
const apos = P.match('founders fund', [{ label: 'Founders Fund', id: P.ACME, entityType: 'company' },
                                       { label: "Founders' Fund", id: P.ID2, entityType: 'company' }]);
console.log(JSON.stringify({ assertion_labels_accepted: accepted, real_names_kept: realKept, real_names_selectable: realSelectable,
  seam_rendered: r1, seam_match: seam ? seam.id : null, triple: r2, triple_unique: new Set(r2).size === r2.length,
  apostrophe_pair_match: apos ? apos.id : null }, null, 1));
