...
const fixed = buildBelt(readSrc(resolve(HERE, 'index.fixD3.ts')));
...
console.log(`\nfabrications the candidate catches and fixD3 ships: ${newlyShipped.length}`);
...
console.log(`truths the candidate destroys and fixD3 rescues: ${newlyRescued.length}`);
