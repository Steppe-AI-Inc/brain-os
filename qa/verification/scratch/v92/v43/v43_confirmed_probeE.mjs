...
const fixed = buildBelt(readSrc(resolve(HERE, 'index.fixD3E.ts')));
...
console.log(`\nfabrications the candidate catches and fixD3E ships: ${newlyShipped.length}`);
...
console.log(`truths the candidate destroys and fixD3E rescues: ${newlyRescued.length}`);
