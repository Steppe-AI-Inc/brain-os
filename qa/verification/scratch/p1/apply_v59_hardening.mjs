...
// sha assertion relaxed: applied on top of the context-budget fix (incident 2026-09-08); anchors are asserted unique below.
const NL = '\r\n';
let s = raw;
...
const out = SRC; // applied in place onto the working candidate
writeFileSync(out, s);
