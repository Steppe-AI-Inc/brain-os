...
| independent Work-PC E2E retest | the Work PC as verifier node, on the deployed build | none, once deployed |
| final Factory V1 acceptance | this pack's rows plus milestones 3–6 on real nodes; PASS advances automatically | none |
