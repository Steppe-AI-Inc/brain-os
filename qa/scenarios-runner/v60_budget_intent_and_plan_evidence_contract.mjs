#!/usr/bin/env node
// PROMOTED from verifier #60 (campaign #120), whose FAIL on 9e39a47 this candidate closes.
// Every DEFECT row was red by design when written and is green here; each is pinned by a mutant in
// qa/verification/scratch/p1/mutation_proof_v60.mjs (9 killed, 0 survived).
//
