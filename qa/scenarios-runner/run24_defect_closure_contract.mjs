// =====================================================================================
// run24 CLOSURE CONTRACT (implementing session) — promoted from VERIFIER #24 (campaign #84).
// Pins the run24 closure of D158 (FIX-C). index.ts sha256 for the candidate it is promoted
// onto: e88370a92f5dc2e89d2014e3ec2f1267056ba0021732e423736b4065884f5834.
//
...
// ANY failure exits nonzero. This file is GREEN on the candidate it is promoted onto (its
// DEFECT pins are closed here); it stays a live regression guard — a future change that
// reopens any pinned defect turns it red.
//
