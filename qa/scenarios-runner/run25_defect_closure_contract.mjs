// =====================================================================================
// run25 CLOSURE CONTRACT (implementing session) — promoted from VERIFIER #25 (campaign #85).
// Pins the run25 closure of D160/D160b (FIX-D, position-based evidential test) and D161 (FIX-E,
// modal-hedge guard). GREEN on the candidate it is promoted onto — its DEFECT pins are CLOSED
// here (440/0) and it stays a live regression guard. index.ts sha256 for that candidate:
// 3b5baa2c268ccb6c1ecb5e2eac0ac0f20ccfafc991af28af3b090416961f7602.
//
