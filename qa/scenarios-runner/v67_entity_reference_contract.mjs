...
console.log('v67_entity_reference_contract — source: ' + INDEX + '\n');

// ==========================================================================================
// 1. DEFECT V67-D1 (P1) — AN ENTITY REFERRED TO BY A COMPOUND NOUN PHRASE IS INVISIBLE TO THE
...
const D1_VERBS = ['archive', 'delete', 'remove', 'restore', 'approve', 'reject', 'close', 'cancel', 'reassign', 'rename'];
{
  ...
  check('DEFECT', 'V67-D1 a compound entity reference is a mutation request the receipt tier can see',
...
}
{
  ...
  check('DEFECT', 'V67-D1 root cause: a referring token is recognised wherever it sits, not only first',
...
// ==========================================================================================
// 2. DEFECT V67-D2 (P1) — THE READ-IDIOM CLAUSE SWALLOWS A REAL ENTITY WHOSE NAME BEGINS WITH AN
...
// ==========================================================================================
{
  ...
  check('DEFECT', 'V67-D2 an idiom noun MODIFYING a real entity is still a mutation request',
...
// ==========================================================================================
// 3. DEFECT V67-D3 (P2) — THE RECEIPT NAMES THE WRONG ENTITY TYPE. V58-D2 fixed this for task and
...
// ==========================================================================================
{
  ...
  check('DEFECT', 'V67-D3 the receipt names the entity type the founder actually asked about',
...
// ==========================================================================================
// 4. DEFECT V67-D4 (P2) — MOVING THE MODAL INTERROGATIVES TO DELIBERATIVE COSTS A FALSE RECEIPT,
...
// ==========================================================================================
{
  ...
  check('DEFECT', 'V67-D4 a deliberative frame gets an HONEST reason, not "could not resolve"',
...
console.log('\nv67_entity_reference_contract: ' + pass + ' passed, '
