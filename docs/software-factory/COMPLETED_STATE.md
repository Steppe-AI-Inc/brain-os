...
Sixteen consecutive independent verifiers (#30–#44) have failed the candidate. **Nothing is deployed.**
...
| 110 ledger entries recording every defect, fix, retraction and dead end | — |
