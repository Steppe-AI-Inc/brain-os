# SEM Brain / Steppe AI — Master Context (HISTORY ONLY since 2026-09-07)

> **This file carries no rules.** It is the continuity narrative of the project up to
> 2026-08-31, kept for history. Anything in it that reads as policy (deploy commands,
> "stay logged in", repository visibility, who may push what) is superseded by
> `CLAUDE.md`, `governance/OPERATING_TRUTH_MODEL.md`, `governance/CANONICAL_WORK_CONTRACT.md`
> and `docs/architecture/FEATURE_COMPLETENESS_CONTRACT.md`. The repository is public.
